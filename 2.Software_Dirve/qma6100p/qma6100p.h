...
/*
 * accelerometer sensor qma6100p driver header file
 *
...
enum qma6100p_enable {
	QMA6100P_DISABLE = 0,
	QMA6100P_ENABLE = 1
};

enum qma6100p_int_map {
	QMA6100P_MAP_INT1,
	QMA6100P_MAP_INT2,
